%{
bayesc.m
  This is the matlab implementation of Nayve Bayes Classifier.
  ...
  Inputs:
      ...
      file:       Result file
%}
function bayesc(predictors, response, train_id, test_id, file)
  load(file,'results');

  fprintf('\n\nNayve Bayes Classifier - Optimize All Hyperparameters\n');    
  classifier = fitcnb(...
    predictors(train_id,:), ...
    response(train_id), ...
